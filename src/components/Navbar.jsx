...
import Logo1 from "../assets/monsoon.png";
  ...
  return (
    <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300 z-10">
      ...
      <ul className="hidden md:flex">
        {/* <li className="transform hover:translate-y-1 transition duration-300"> */}
        <li className="transform hover:scale-125 hover:font-bold transition duration-300">
      ...
      <div
        onClick={handleClick}
        className="md:hidden z-10 flex justify-end items-center w-full"
      >
        {!nav ? <FaBars /> : <FaTimes />}
      </div>
